...
module.exports = {
  ...
  devServer: { port: 3005, historyApiFallback: true, headers: { "Access-Control-Allow-Origin": "*" } },
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: "mfe_offers", filename: "remoteEntry.js",
      exposes: { "./Offers": "./src/components/Offers" },
